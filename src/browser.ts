...
export class BrowserTextMedia implements TextMediaInterface {
...
export class BrowserBinaryMedia implements BinaryMediaInterface {
...
// ============================================================================================================================================
export const BrowserPitoMediaType = <ContentMediaType extends MediaType = MediaType, ContentEncoding extends Encoding = 'base64'>(mediaType: ContentMediaType, options?: { encoding?: ContentEncoding }): PitoMediaType<ContentMediaType> => {
    return {
        type: 'string',
        contentMediaType: mediaType,
        contentEncoding: options?.encoding,
        $typeof: 'class',
        $constructor: (isTextMediaType(mediaType) ? BrowserTextMedia : BrowserBinaryMedia),
        $wrap(data: BaseMedia) {
        ...
        $unwrap(raw: string) {
            if (isBinaryMediaType(mediaType)) {
                ...
                return new BrowserBinaryMedia(mediaType as any, raw, options?.encoding)
            }
            if (isTextMediaType(mediaType)) {
                return new BrowserTextMedia(mediaType as any, raw)
            }
            throw new Error()
        },
        $strict(this) {
...
// ============================================================================================================================================
Object.defineProperty(plugin, 'Media', { value: BrowserPitoMediaType, configurable: false, writable: false })
